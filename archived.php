...
<html>
    ...
    <body>
        ...
        <a id="archived" href="dashboard.php">Go to dashboard</a>
        ...
        <?php
            ...
            $sql='SELECT * FROM service WHERE archived =1 ';	
        ?>
...
<?php
    function showData($a) {
        ...
        while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td><a href='reverse.php?id=".$row['id']."'><img src='reverse.png' style='width:42px;height:42px;border:0;'></a></td>";
